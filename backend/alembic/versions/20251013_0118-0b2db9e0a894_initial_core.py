...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_personas_is_active"), "personas", ["is_active"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "visitor_metadata", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
        sa.Column(
            "started_at",
            sa.DateTime(timezone=True),
    ...
    op.create_index(
        op.f("ix_conversations_persona_id"),
        "conversations",
        ["persona_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_knowledge_modules_is_active"),
        "knowledge_modules",
        ["is_active"],
        unique=False,
    )
    op.create_index(
        op.f("ix_knowledge_modules_module_type"),
        "knowledge_modules",
        ["module_type"],
        unique=False,
    )
    op.create_index(
        op.f("ix_knowledge_modules_persona_id"),
        "knowledge_modules",
        ["persona_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["module_id"], ["knowledge_modules.id"], ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
        op.f("ix_knowledge_chunks_module_id"),
        "knowledge_chunks",
        ["module_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column(
            "sources_used", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
    ...
    op.create_index(
        op.f("ix_owner_feedback_is_applied"),
        "owner_feedback",
        ["is_applied"],
        unique=False,
    )
    op.create_index(
        op.f("ix_owner_feedback_persona_id"),
        "owner_feedback",
        ["persona_id"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_knowledge_modules_persona_id"), table_name="knowledge_modules"
    )
    op.drop_index(
        op.f("ix_knowledge_modules_module_type"), table_name="knowledge_modules"
    )
    op.drop_index(
        op.f("ix_knowledge_modules_is_active"), table_name="knowledge_modules"
    )
